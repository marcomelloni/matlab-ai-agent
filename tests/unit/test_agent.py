...
class TestMatlabAIAgent(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Create patches
        self.llm_patch = patch('src.agent.LLMInterface', return_value=self.mock_llm)
        self.matlab_patch = patch('src.agent.MatlabEngine', return_value=self.mock_matlab)
        ...
        self.mock_matlab.execute_code.return_value = ("Success", {"success": True})
    ...
    def test_add_message(self):
        ...
        self.assertEqual(self.agent.conversation_history[0]["content"], "Test message")
    ...
    def test_execute_simulation_success(self):
        ...
        self.mock_matlab.execute_code.assert_called_once_with("% Test simulation")
    ...
    def test_fix_code_with_llm(self):
        ...
        self.mock_llm.fix_code.assert_called_once_with("% Code with errors", ["Error 1", "Error 2"])
